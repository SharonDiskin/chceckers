...
namespace C20_Ex02
{
    public class Player
    {
        ...
        public bool AteOpponent(string i_Move)
        {
            ...
            return Math.Abs(i_Move[0] - i_Move[3]) == 2;
        }
        ...
        private List<string> possibleNoneEatingMovesForPlayerX(Board i_Board)
        {
        ...
        private List<string> possibleNoneEatingMovesForPlayerO(Board i_Board)
        {
            List<string> possibleMoves = new List<string>();
        ...
        public List<string> PossibleNonEatingMoves(Board i_Board)
        {
        ...
        private List<string> possibleEatingMovesForPlayerO(Board i_Board)
        {
            List<string> possibleMoves = new List<string>();
        ...
        private List<string> possibleEatingMovesForPlayerX(Board i_Board)
        {
            List<string> possibleMoves = new List<string>();
        ...
        public List<string> PossibleEatingMoves(Board i_Board)
        {
            List<string> possibleMoves;
        ...
        public bool CanEatMore(Board i_Board, string i_Move)
        {
            int coordinateColIndex = i_Move[3] - 'A';
            int coordinateRowIndex = i_Move[4] - 'a';
        ...
        private void addMoveToMovesList(ref List<string> io_MovesList, int i_ColNum, int i_RowNum, eMove i_MoveInCol, eMove i_MoveInRow)
        {
            string validMove = string.Format(
                "{0}{1}>{2}{3}",
                (char)('A' + i_ColNum),
                (char)('a' + i_RowNum),
                (char)('A' + i_ColNum + i_MoveInCol),
                (char)('a' + i_RowNum + i_MoveInRow));
